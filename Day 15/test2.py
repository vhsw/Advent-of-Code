...
def find_closest_target(coords, target, elements):
    ...
    print(trace)
    print(coords, distance[closest], closest)
    raise Exception
...
def move_once(fighter, elements):
    if fighter[3] == 'E':
        ...
        target = 'E'
    next_coords, distance = find_closest_target(
...
if __name__ == '__main__':
    # with open('Day 15/example.0.txt') as f:
    with open('Day 15/input.txt') as f:
        raw_data = f.read().splitlines()
    data_example_me = raw_data
    ...
    print('Example:')
    print('Solution of 1 is', part1(data_example_me, debug=True))
